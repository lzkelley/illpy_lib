...
NUMS_EPAS  = { 2: np.array([ 61628,  53861,  56400,  62551,   36906,  66419, 65997,  74870, 55591, 56132,
                             32836,  47564,  15070,  71370,   83554,  36227, 24929,  59653, 74329, 55481 ]) }


NUMS_NULLS = { 2: np.array([ 98645,  42640,  104561, 103399,  101025, 75064, 85549,  84796,
                             55151,  106001, 56933,  49007,   32557,  63844, 27716,  78516,
                             3026,   72601,  91679,  89625,   82511,  3034,  92484,  86035,
                             104021, 66022,  78603,  104659,  78803,  98268, 115876, 97312,
                             101598, 94810,  99410,  84564,   98779,  94954, 84278,  84121 ]) }
